package com.kc.widget.pullrefreshview.indicator;
...
public class PtrIndicator {
    ...
    // 根据高度 和 mRatioOfHeaderHeightToRefresh 一起算出来的
    protected int mOffsetToRefresh = 0;
    // onMove和onPress时，都会调用该方法，记录上次滑动时的位置
    ...
    // 在下拉刷新view onMeasure时，调用更新高度的方法
    private int mHeaderHeight;
    // 在下拉刷新view dispatchTouchEvent down事件时，将当前y设置为它
